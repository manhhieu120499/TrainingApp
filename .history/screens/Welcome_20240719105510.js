  ...
  return (
    <View style={stylesContainer}>
      ...
      >
        ...
        <View style={{ flex: 60, width: "100%" }}>
          ...
          >
            <TouchableOpacity style={stylesButton}>
              <Text style={stylesTextButton}>Badminton user</Text>
            </TouchableOpacity>
            <TouchableOpacity style={stylesButton}>
              <Text style={stylesTextButton}>Business</Text>
            </TouchableOpacity>
            <TouchableOpacity style={stylesButton}>
              <Text style={stylesTextButton}>Individual</Text>
            </TouchableOpacity>
          </View>
        </View>
        {/** footer */}
        ...
        >
          <TouchableOpacity style={stylesButton}>
            <Text style={stylesTextButton}>Next</Text>
          </TouchableOpacity>
