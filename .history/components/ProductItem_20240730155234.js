					...
					<View style={{ flexDirection: 'row' }}>
						<TouchableOpacity>
							<Icon
								...
								size={15}
								style={{
									color: 1 <= rating ? colors.star : 'null',
								}}
							/>
						</TouchableOpacity>
						<TouchableOpacity>
							<Icon
								...
								size={15}
								style={{
									color: 2 <= rating ? colors.star : 'null',
								}}
							/>
						</TouchableOpacity>
						<TouchableOpacity>
							<Icon
								...
								size={15}
								style={{
									color: 3 <= rating ? colors.star : 'null',
								}}
							/>
						</TouchableOpacity>
						<TouchableOpacity>
							<Icon
								...
								size={15}
								style={{
									color: 4 <= rating ? colors.star : 'null',
								}}
							/>
						</TouchableOpacity>
						<TouchableOpacity>
							<Icon
								...
								size={15}
								style={{
									color: 5 <= rating ? colors.star : 'null',
								}}
							/>
						</TouchableOpacity>
					</View>
